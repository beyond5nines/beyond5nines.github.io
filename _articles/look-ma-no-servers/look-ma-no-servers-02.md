---
layout: post
title: "The specified subnet does not have enough free addresses to satisfy the request — Fix"
date: 2026-04-10 12:00:00 -0000
categories: aws glue serverless
series: Look Ma! no servers
excerpt: "Split the shared subnet by blast radius, then add admission control: a pre-launch check that refuses jobs the subnet can't absorb."
---
